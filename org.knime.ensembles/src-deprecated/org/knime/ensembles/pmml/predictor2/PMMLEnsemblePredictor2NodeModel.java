...
/**
 * This is the model implementation of PMMLEnsemblePredictor. This node takes a PMML ensemble document and an input
 * table and uses each model in the ensemble on the given data. The individual results from applying the models are then
 * combined using the multiple model method specified in the PMML document.
 *
