 ...
 * @since 2.8
 */
public class PMMLEnsembleNodeDialog extends DefaultNodeSettingsPane {

    /**
     * New pane for configuring PMMLEnsemble node dialog.
    ...
    protected PMMLEnsembleNodeDialog() {
        ...
        addDialogComponent(weightColumnAvailable);
        addDialogComponent(weightColumn);
