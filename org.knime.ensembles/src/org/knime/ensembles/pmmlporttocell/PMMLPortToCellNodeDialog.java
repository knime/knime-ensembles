...
/**
 * Dialog for the PMML Port To Cell node allowing to specify the row ID,
 * manually or by flow variable.
 * @author Thomas Gabriel, KNIME.com, Zurich, Switzerland
 */
public class PMMLPortToCellNodeDialog extends DefaultNodeSettingsPane {
     ...
     * Create new dialog.
     */
    public PMMLPortToCellNodeDialog() {
