...
public class PMMLPredictorNodeModel3 extends NodeModel {
    ...
    protected PortObject[] execute(final PortObject[] inObjects, final ExecutionContext exec) throws Exception {
        ...
        switch (type) {
            ...
            case NaiveBayesModel: {
                NaiveBayesPredictorNodeModel3 model = new NaiveBayesPredictorNodeModel3();
                return model.execute(inObjects, exec);
            }
            default:
    ...
    private static GradientBoostingPMMLPredictorNodeModel<?>
        getGradientBoostedTreesPredictorNodeModel(final Node miningModel) {
