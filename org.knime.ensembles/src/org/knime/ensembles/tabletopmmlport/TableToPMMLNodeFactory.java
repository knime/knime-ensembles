...
/**
 * The node factory for the table to pmml node.
...
public class TableToPMMLNodeFactory extends NodeFactory<TableToPMMLNodeModel> {
     ...
     */
    @Override
    public NodeView<TableToPMMLNodeModel> createNodeView(final int viewIndex,
            final TableToPMMLNodeModel nodeModel) {
        return null;
    }
