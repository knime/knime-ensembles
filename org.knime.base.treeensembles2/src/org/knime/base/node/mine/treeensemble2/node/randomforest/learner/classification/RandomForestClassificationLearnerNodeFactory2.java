...
public class RandomForestClassificationLearnerNodeFactory2 extends
    ...
    private static final List<PortDescription> INPUT_PORTS = List.of(fixedPort("Input Data", """
            The data to be learned from. They must contain at least one nominal target column and either a
    ...
    private static final List<PortDescription> OUTPUT_PORTS = List.of(fixedPort("Out-of-bag Predictions", """
            ...
            learning.) The out-of-bag predictions can be used to get an estimate of the generalization error of the
            random forest by feeding them into the Scorer node.
