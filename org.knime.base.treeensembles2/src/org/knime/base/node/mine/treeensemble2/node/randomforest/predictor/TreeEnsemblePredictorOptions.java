...
/**
 * Holds the shared tree ensemble predictor options. The settings remain hidden in dialogs by default and can be exposed
 * selectively by subclasses adding {@link org.knime.node.parameters.Widget} annotations where required.
 */
...
public class TreeEnsemblePredictorOptions implements NodeParameters, WidgetGroup {
    ...
    @Effect(predicate = ChangePredictionColumnNameEffectRef.class, type = EffectType.ENABLE)
