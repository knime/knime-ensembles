...
abstract class TargetColumnAutoSelectionProvider extends ColumnNameAutoGuessValueProvider {

    protected TargetColumnAutoSelectionProvider() {
        super(AbstractTreeLearnerOptions.TargetColumnRef.class);
    }
