...
public abstract class AbstractTreeLearnerOptions implements NodeParameters {
    ...
    private static final class AttributeColumnsProvider extends CompatibleColumnsProvider {
        ...
        public void init(final StateProviderInitializer initializer) {
            m_targetSupplier = initializer.computeFromValueSupplier(References.TargetColumnValueRef.class);
    ...
    @Modification.WidgetReference(References.TargetColumnWidgetRef.class)
    @ValueReference(References.TargetColumnValueRef.class)
    @Persistor(Persistors.TargetColumnPersistor.class)
    ...
    @Modification.WidgetReference(References.AttributeColumnsWidgetRef.class)
    ...
    @Modification.WidgetReference(References.IgnoreColumnsWithoutDomainWidgetRef.class)
    ...
    @Modification.WidgetReference(References.AverageSplitPointsWidgetRef.class)
    ...
    @Modification.WidgetReference(References.BinaryNominalSplitsWidgetRef.class)
    ...
    @CustomValidation(Validations.HardCodedRootValidationProvider.class)
