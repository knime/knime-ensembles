...
/**
 * Node parameters for Gradient Boosted Trees Learner (Regression).
 *
...
@Modification(GradientBoostingRegressionLearnerNodeFactory2Parameters.WidgetModifier.class)
public final class GradientBoostingRegressionLearnerNodeFactory2Parameters extends RegressionTreeLearnerOptions {
    ...
    /**
     * Overshadows a field in the parent class to set a default value of 4.
     */
    ...
    /**
     * Overshadows a field in the parent class to set a default value of NONE.
     */
    ...
    @PersistEmbedded
    @Modification(ShowAlphaWidgetModifier.class)
    GradientBoostingParameters m_gradientBoostingParams = new GradientBoostingParameters();

    static final class ShowAlphaWidgetModifier implements Modification.Modifier {

        @Override
        public void modify(final Modification.WidgetGroupModifier group) {
            GradientBoostingParameters.showAlpha(group);
        }
    }

    /**
     * Overshadows a field in the parent class to set a default value of SAME_FOR_TREE.
     */
    ...
    GradientBoostingRegressionLearnerNodeFactory2Parameters() {
        super();
    }

    GradientBoostingRegressionLearnerNodeFactory2Parameters(final NodeParametersInput input) {
        super(input);
    }
