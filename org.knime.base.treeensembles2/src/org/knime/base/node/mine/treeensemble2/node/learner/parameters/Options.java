...
public final class Options {
    ...
    enum RowSamplingModeOption {
            @Label(value = "Random", description = """
                    ...
                    """)
            RANDOM(RowSamplerFactory.RowSamplingMode.Random), @Label(value = "Stratified", description = """
                    Sample rows stratified by the target class distribution.
                    """)
            STRATIFIED(RowSamplerFactory.RowSamplingMode.Stratified), @Label(value = "Equal size", description = """
