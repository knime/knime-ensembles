...
@Modification(RandomForestRegressionLearnerNodeParameters.WidgetModifier.class)
final class RandomForestRegressionLearnerNodeParameters extends RegressionTreeLearnerOptions {

    RandomForestRegressionLearnerNodeParameters() {
        super();
    }

    RandomForestRegressionLearnerNodeParameters(final NodeParametersInput input) {
        super(input);
    }
