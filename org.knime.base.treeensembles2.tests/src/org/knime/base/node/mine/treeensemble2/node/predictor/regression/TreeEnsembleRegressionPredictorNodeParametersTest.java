...
/**
 * Snapshot test for {@link TreeEnsembleRegressionPredictorNodeParameters}.
 */
@SuppressWarnings("restriction")
final class TreeEnsembleRegressionPredictorNodeParametersTest extends DefaultNodeSettingsSnapshotTest {

    TreeEnsembleRegressionPredictorNodeParametersTest() {
        super(getConfig());
    }
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(TreeEnsembleRegressionPredictorNodeParameters.class) //
            .testJsonFormsWithInstance(SettingsType.MODEL, TreeEnsembleRegressionPredictorNodeParametersTest::readSettings) //
            .testNodeSettingsStructure(TreeEnsembleRegressionPredictorNodeParametersTest::readSettings) //
            .build();
    }
    ...
    private static TreeEnsembleRegressionPredictorNodeParameters readSettings() {
        try {
            var path = getSnapshotPath(TreeEnsembleRegressionPredictorNodeParametersTest.class).getParent()
                .resolve("node_settings")
                .resolve("TreeEnsembleRegressionPredictorNodeParameters.xml");
            try (var fis = new FileInputStream(path.toFile())) {
                var nodeSettings = NodeSettings.loadFromXML(fis);
                return NodeParametersUtil.loadSettings(
                    nodeSettings.getNodeSettings(SettingsType.MODEL.getConfigKey()),
                    TreeEnsembleRegressionPredictorNodeParameters.class);
            }
