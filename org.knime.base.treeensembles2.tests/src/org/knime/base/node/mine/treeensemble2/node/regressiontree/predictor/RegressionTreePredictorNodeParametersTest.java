...
/**
 * Snapshot test for {@link RegressionTreePredictorNodeParameters}.
 */
@SuppressWarnings("restriction")
final class RegressionTreePredictorNodeParametersTest extends DefaultNodeSettingsSnapshotTest {

    RegressionTreePredictorNodeParametersTest() {
        super(getConfig());
    }
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(RegressionTreePredictorNodeParameters.class) //
    ...
    private static PortObjectSpec createModelPortSpec() {
        return new RegressionTreeModelPortObjectSpec(createTrainingTableSpec());
    }

    private static DataTableSpec createTrainingTableSpec() {
        return new DataTableSpec(new String[]{"Feature", "Universe_0_0"},
    ...
    private static RegressionTreePredictorNodeParameters readSettings() {
        try {
            var path = getSnapshotPath(RegressionTreePredictorNodeParametersTest.class).getParent()
                .resolve("node_settings")
                .resolve("RegressionTreePredictorNodeParameters.xml");
