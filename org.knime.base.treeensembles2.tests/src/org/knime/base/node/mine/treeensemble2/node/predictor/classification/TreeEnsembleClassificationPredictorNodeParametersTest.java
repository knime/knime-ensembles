...
/**
 * Snapshot test for {@link TreeEnsembleClassificationPredictorNodeParameters}.
 */
@SuppressWarnings("restriction")
final class TreeEnsembleClassificationPredictorNodeParametersTest extends DefaultNodeSettingsSnapshotTest {

    TreeEnsembleClassificationPredictorNodeParametersTest() {
        super(getConfig());
    }
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(TreeEnsembleClassificationPredictorNodeParameters.class) //
    ...
    private static TreeEnsembleClassificationPredictorNodeParameters readSettings() {
        try {
            var path = getSnapshotPath(TreeEnsembleClassificationPredictorNodeParameters.class).getParent()
                .resolve("node_settings")
                .resolve("TreeEnsembleClassificationPredictorNodeParameters.xml");
            try (var fis = new FileInputStream(path.toFile())) {
                var nodeSettings = NodeSettings.loadFromXML(fis);
                return NodeParametersUtil.loadSettings(
                    nodeSettings.getNodeSettings(SettingsType.MODEL.getConfigKey()),
                    TreeEnsembleClassificationPredictorNodeParameters.class);
            }
