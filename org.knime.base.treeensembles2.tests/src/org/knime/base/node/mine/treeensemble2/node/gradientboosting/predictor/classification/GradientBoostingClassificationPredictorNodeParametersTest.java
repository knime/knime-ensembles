...
/**
 * Snapshot test for {@link GradientBoostingClassificationPredictorNodeParameters}.
 */
@SuppressWarnings("restriction")
final class GradientBoostingClassificationPredictorNodeParametersTest extends DefaultNodeSettingsSnapshotTest {

    GradientBoostingClassificationPredictorNodeParametersTest() {
        super(getConfig());
    }
    ...
    private static SnapshotTestConfiguration getConfig() {
        return SnapshotTestConfiguration.builder() //
            ...
            .testJsonFormsForModel(GradientBoostingClassificationPredictorNodeParameters.class) //
    ...
    private static GradientBoostingClassificationPredictorNodeParameters readSettings() {
        try {
            var path = getSnapshotPath(GradientBoostingClassificationPredictorNodeParameters.class).getParent()
                .resolve("node_settings")
                .resolve("GradientBoostingClassificationPredictorNodeParameters.xml");
